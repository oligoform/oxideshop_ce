...
use OxidEsales\EshopCommunity\Internal\Twig\TwigEngineConfigurationInterface;
...
class TwigEngineTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function getEngine($engine_type = 'twig')
    {
        ...
        $configuration = $this->getMockBuilder('OxidEsales\EshopCommunity\Internal\Twig\TwigEngineConfigurationInterface')->getMock();
