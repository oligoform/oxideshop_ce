...
use OxidEsales\EshopCommunity\Internal\Smarty\SmartyBuilder;
...
class SmartyBuilderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSmartySettingsAreSetCorrect($securityMode, $smartySettings)
    {
        ...
        $configurationFactory = new SmartyConfigurationFactory(
            $smartyContext,
            new SmartySettingsDataProvider($smartyContext),
            new SmartySecuritySettingsDataProvider($smartyContext),
            new SmartyResourcesDataProvider(),
            new SmartyPrefiltersDataProvider($smartyContext),
            new SmartyPluginsDataProvider($smartyContext)
            );
